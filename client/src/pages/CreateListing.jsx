        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-blue-600 border border-blue-600 rounded uppercase hover:shadow-lg disabled:opacity-95"
            >
            ...
            formData.imageUrls.map((url, idx) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-3 bg-slate-200 text-sm text-red-800 rounded-lg uppercase hover:opacity-90"
                >
                  Delete
                </button>
              </div>
          ...
          <button
            ...
            className="p-3 mt-2 bg-blue-900 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80"
          >
